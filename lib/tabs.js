    ...
    _createClass(Tabs, [{
      ...
      value: function dress(tabsContainer) {
        ...
        if (tabPanes.length > 0) {
          ...
          // TODO melden aan AIV
          //  - dat >> href= << selector nu >> href$= << geworden is daar de hash altijd laatst komt
          //  - we weten echter niet altijd de volledige href, cfr hoe SPA's url's gebruiken om te navigeren
          ...
          if (activeTab) {
            ...
            //  verplaatst hebben.
            // TODO melden aan AIV
            //  als je direct wil navigeren naar een bepaalde tab i.e. je vult
            //  de hash in op voorhand in de url (eg localhost/pad#test) dan krijg
            //  je in single page applications een endless loop tussen de
            //  activeTab.click en de toggleBtnEl.click (hierboven).
